...
Deep learning presents significant opportunities for climate change mitigation. Continued research and development in this field could accelerate the transition to sustainable technologies and help achieve global climate goals.`,
    authors: ["Dr. Elena Rodriguez", "Prof. Michael Chen", "Dr. Sarah Thompson"],
    journal: "Nature Climate Change",
    doi: "10.1038/s41558-024-01234-5",
    publishedDate: "2024-01-15",
    keywords: ["deep learning", "climate change", "renewable energy", "carbon footprint", "environmental monitoring", "artificial intelligence"],
  ...
  },
  {
    ...
    abstract: "Quantum computing represents a paradigm shift in computational capabilities, with profound implications for cryptography and cybersecurity. This paper explores current quantum computing technologies and their applications in breaking traditional encryption methods while simultaneously enabling quantum-resistant security protocols. We examine the timeline for quantum supremacy in cryptographic applications and analyze the development of post-quantum cryptography standards. Our research indicates that while current quantum computers pose limited immediate threats to existing encryption, rapid advances suggest that quantum-resistant protocols must be implemented within the next decade to maintain data security.",
    authors: ["Prof. David Zhang", "Dr. Maria Gonzalez", "Dr. James Wilson"],
    journal: "Physical Review X",
    doi: "10.1103/PhysRevX.14.021032",
    publishedDate: "2024-03-12",
    keywords: ["quantum computing", "cryptography", "cybersecurity", "quantum supremacy", "post-quantum cryptography"],
...
async function importArticle(article: ArticleData) {
  try {
    ...
    const journal = await createJournalIfNotExists(article.journal, article.issn);
    ...
    const [paper] = await db.insert(papers).values({
      ...
      status: "published",
      isPublished: true,
      publishedAt: article.publishedDate ? new Date(article.publishedDate) : new Date(),
